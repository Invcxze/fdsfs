...
export default function Signup({token, setToken}) {
    ...
    const [error, setError] = useState({"code": '', "message": "", "errors": {"password": '', "email": "", "fio": ''}})
            ...
            <div class="row">
                ...
                <h1 class="h3 mb-3 fw-normal">Пожалуйста заполните все поля</h1>
                        <div class="form-floating mb-3">
                            <input type="text" style={error.code == 422 && error.errors.fio ? {"border-color": "red"} : {}} value={fio} onChange={(event) => setFio(event.target.value)} class="form-control" id="floatingFio" placeholder="ФИО" />
